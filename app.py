...
# Render.com:n ympäristössä varmistetaan että sovellus kuuntelee oikeaa porttia
if os.environ.get("RENDER"):
    port = int(os.environ.get("PORT", 8080))
    app.run(host="0.0.0.0", port=port)

# Lisätään konfiguraatio gunicorn:ille
app.config['SERVER_NAME'] = None

# Varmistetaan että Flask-sovellus kuuntelee oikeaa porttia
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 8080))
