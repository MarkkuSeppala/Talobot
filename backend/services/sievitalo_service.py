...
from SQL_kyselyt import (
    lisaa_ikkunat_kantaan_ja_koko_x_100,
...
class SievitaloService:
    ...
    def process_document(self, pdf_path: str, toimitussisalto_id: int) -> dict:
        """
        Käsittele Sievitalo-dokumentti
        ...
        try:
            ...
            if analysis_result.get('ikkunat'):
                lisaa_ikkunat_kantaan_ja_koko_x_100(analysis_result['ikkunat'], toimitussisalto_id)
